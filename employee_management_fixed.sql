-- =====================================================
-- SCRIPT CORRIGIDO DE EXPANSÃO DO CADASTRO DE FUNCIONÁRIOS
...
-- 6. VERIFICAR E ADICIONAR COLUNAS NA TABELA EMPLOYEES (VERSÃO CORRIGIDA)
-- =====================================================
DO $$
BEGIN
  -- Verificar se a coluna position_id já existe
  ...
  -- Verificar se a coluna work_schedule_id já existe
  ...
  -- Verificar se a coluna department_id já existe
  ...
  -- Verificar se a coluna manager_id já existe
  ...
  -- Verificar se a coluna salario_base já existe
  ...
  -- Verificar se a coluna telefone já existe
  ...
  -- Verificar se a coluna nome_mae já existe
  ...
  -- Verificar se a coluna nome_pai já existe
  ...
  -- REMOVIDO nivel_escolaridade da tabela employees pois já existe na tabela employee_education
  -- A informação de escolaridade será gerenciada através da tabela employee_education
END $$;
...
-- 6. ✅ Expansão da tabela employees com campos adicionais (SEM nivel_escolaridade)
-- 7. ✅ Views para facilitar consultas
-- 8. ✅ Funções RPC para operações comuns
