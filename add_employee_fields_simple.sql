-- Script simplificado para adicionar campos na tabela employees
...
-- =====================================================
-- 2. ADICIONAR CONSTRAINTS (SEM IF NOT EXISTS)
-- =====================================================

-- Adicionar constraint para tipo de banco de horas
DO $$
BEGIN
...
-- Adicionar constraint para tipo de deficiência
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints 
...
-- Adicionar constraint para grau de deficiência
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints 
