...
ALTER TYPE "rh"."benefit_status_enum" OWNER TO "postgres";
...
ALTER TYPE "rh"."payment_method_enum" OWNER TO "postgres";
...
ALTER TYPE "rh"."payment_status_enum" OWNER TO "postgres";
...
CREATE TYPE "rh"."tipo_premiacao_enum" AS ENUM (
    'fixa',
    'variavel',
    'por_meta',
    'por_producao'
...
ALTER TYPE "rh"."tipo_premiacao_enum" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "rh"."calculate_all_equipment_rental_absence_discounts"("p_company_id" "uuid", "p_year" integer, "p_month" integer) RETURNS TABLE("equipment_rental_id" "uuid", "employee_id" "uuid", "employee_name" "text", "equipment_name" character varying, "equipment_type" character varying, "period" "text", "monthly_value" numeric, "daily_value" numeric, "work_days" integer, "absence_days" integer, "total_discount" numeric, "final_value" numeric, "absence_details" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "rh"."calculate_all_equipment_rental_absence_discounts"("p_company_id" "uuid", "p_year" integer, "p_month" integer) OWNER TO "postgres";


COMMENT ON FUNCTION "rh"."calculate_all_equipment_rental_absence_discounts"("p_company_id" "uuid", "p_year" integer, "p_month" integer) IS 'Calcula descontos por ausência para todos os equipamentos ativos de uma empresa usando 30 dias fixos, sem influência da escala de trabalho';
...
CREATE OR REPLACE FUNCTION "rh"."calculate_equipment_rental_absence_discount"("p_equipment_rental_id" "uuid", "p_company_id" "uuid", "p_year" integer, "p_month" integer) RETURNS TABLE("equipment_rental_id" "uuid", "employee_id" "uuid", "employee_name" "text", "equipment_name" character varying, "equipment_type" character varying, "period" "text", "monthly_value" numeric, "daily_value" numeric, "work_days" integer, "absence_days" integer, "total_discount" numeric, "final_value" numeric, "absence_details" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_equipment_record RECORD;
...
ALTER FUNCTION "rh"."calculate_equipment_rental_absence_discount"("p_equipment_rental_id" "uuid", "p_company_id" "uuid", "p_year" integer, "p_month" integer) OWNER TO "postgres";


COMMENT ON FUNCTION "rh"."calculate_equipment_rental_absence_discount"("p_equipment_rental_id" "uuid", "p_company_id" "uuid", "p_year" integer, "p_month" integer) IS 'Calcula desconto por ausência para um equipamento específico usando 30 dias fixos, sem influência da escala de trabalho';
...
CREATE OR REPLACE FUNCTION "rh"."update_funcionario_beneficios_historico_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "rh"."update_funcionario_beneficios_historico_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "rh"."update_premiacao_assignments_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "rh"."update_premiacao_assignments_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "rh"."update_premiacao_configs_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "rh"."update_premiacao_configs_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "rh"."benefit_payment_configs" (
    ...
    "allowed_payment_methods" "jsonb" DEFAULT '["flash", "transfer", "pix"]'::"jsonb" NOT NULL,
    "flash_api_key" character varying(255),
    "flash_company_id" character varying(255),
    "is_active" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
);
...
ALTER TABLE "rh"."benefit_payment_configs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "rh"."benefit_payments" (
    ...
    "payment_status" "rh"."payment_status_enum" DEFAULT 'pending'::"rh"."payment_status_enum",
    "flash_transaction_id" character varying(255),
...
ALTER TABLE "rh"."benefit_payments" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "rh"."premiacao_assignments" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "company_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "premiacao_config_id" "uuid" NOT NULL,
    "is_active" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
);
...
ALTER TABLE "rh"."premiacao_assignments" OWNER TO "postgres";


COMMENT ON TABLE "rh"."premiacao_assignments" IS 'Atribuições de premiações para funcionários';



COMMENT ON COLUMN "rh"."premiacao_assignments"."employee_id" IS 'ID do funcionário';



COMMENT ON COLUMN "rh"."premiacao_assignments"."premiacao_config_id" IS 'ID da configuração de premiação';



CREATE TABLE IF NOT EXISTS "rh"."premiacao_configs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "company_id" "uuid" NOT NULL,
    "nome" character varying(255) NOT NULL,
    "descricao" "text",
    "tipo_premiacao" "rh"."tipo_premiacao_enum" NOT NULL,
    "valor_base" numeric(10,2),
    "valor_por_meta" numeric(10,2),
    "meta_minima" numeric(10,2),
    "meta_maxima" numeric(10,2),
    "percentual_producao" numeric(5,2),
    "valor_maximo" numeric(10,2),
    "valor_minimo" numeric(10,2),
    "is_active" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "check_percentual_producao" CHECK (((("tipo_premiacao" = 'por_producao'::"rh"."tipo_premiacao_enum") AND ("percentual_producao" IS NOT NULL)) OR ("tipo_premiacao" <> 'por_producao'::"rh"."tipo_premiacao_enum"))),
    CONSTRAINT "check_valor_base" CHECK (((("tipo_premiacao" = 'fixa'::"rh"."tipo_premiacao_enum") AND ("valor_base" IS NOT NULL)) OR (("tipo_premiacao" <> 'fixa'::"rh"."tipo_premiacao_enum") AND ("valor_base" IS NULL)))),
    CONSTRAINT "check_valor_por_meta" CHECK (((("tipo_premiacao" = 'por_meta'::"rh"."tipo_premiacao_enum") AND ("valor_por_meta" IS NOT NULL) AND ("meta_minima" IS NOT NULL)) OR ("tipo_premiacao" <> 'por_meta'::"rh"."tipo_premiacao_enum"))),
    CONSTRAINT "check_valores_positivos" CHECK (((COALESCE("valor_base", (0)::numeric) >= (0)::numeric) AND (COALESCE("valor_por_meta", (0)::numeric) >= (0)::numeric) AND (COALESCE("meta_minima", (0)::numeric) >= (0)::numeric) AND (COALESCE("meta_maxima", (0)::numeric) >= (0)::numeric) AND (COALESCE("percentual_producao", (0)::numeric) >= (0)::numeric) AND (COALESCE("valor_maximo", (0)::numeric) >= (0)::numeric) AND (COALESCE("valor_minimo", (0)::numeric) >= (0)::numeric)))
);


ALTER TABLE "rh"."premiacao_configs" OWNER TO "postgres";


COMMENT ON TABLE "rh"."premiacao_configs" IS 'Configurações de premiações e produtividade';



COMMENT ON COLUMN "rh"."premiacao_configs"."tipo_premiacao" IS 'Tipo de premiação: fixa, variavel, por_meta, por_producao';



COMMENT ON COLUMN "rh"."premiacao_configs"."valor_base" IS 'Valor base para premiação fixa';



COMMENT ON COLUMN "rh"."premiacao_configs"."valor_por_meta" IS 'Valor por meta atingida';



COMMENT ON COLUMN "rh"."premiacao_configs"."percentual_producao" IS 'Percentual sobre a produção para cálculo';
...
ALTER TABLE ONLY "rh"."benefit_payment_configs"
    ADD CONSTRAINT "benefit_payment_configs_company_id_benefit_type_key" UNIQUE ("company_id", "benefit_type");



ALTER TABLE ONLY "rh"."benefit_payment_configs"
    ADD CONSTRAINT "benefit_payment_configs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "rh"."benefit_payments"
    ADD CONSTRAINT "benefit_payments_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "rh"."premiacao_assignments"
    ADD CONSTRAINT "premiacao_assignments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "rh"."premiacao_configs"
    ADD CONSTRAINT "premiacao_configs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "rh"."premiacao_assignments"
    ADD CONSTRAINT "unique_employee_premiacao" UNIQUE ("employee_id", "premiacao_config_id");
...
CREATE INDEX "idx_benefit_payments_company_id" ON "rh"."benefit_payments" USING "btree" ("company_id");



CREATE INDEX "idx_benefit_payments_created_at" ON "rh"."benefit_payments" USING "btree" ("created_at");



CREATE INDEX "idx_benefit_payments_employee_id" ON "rh"."benefit_payments" USING "btree" ("employee_id");



CREATE INDEX "idx_benefit_payments_status" ON "rh"."benefit_payments" USING "btree" ("payment_status");
...
CREATE INDEX "idx_employee_bank_accounts_employee_id" ON "rh"."employee_bank_accounts" USING "btree" ("employee_id");
...
CREATE INDEX "idx_funcionario_beneficios_historico_company_id" ON "rh"."funcionario_beneficios_historico" USING "btree" ("company_id");



CREATE INDEX "idx_funcionario_beneficios_historico_created_at" ON "rh"."funcionario_beneficios_historico" USING "btree" ("created_at");
...
CREATE INDEX "idx_funcionario_beneficios_historico_payment_status" ON "rh"."funcionario_beneficios_historico" USING "btree" ("payment_status");



CREATE INDEX "idx_funcionario_beneficios_historico_periodo" ON "rh"."funcionario_beneficios_historico" USING "btree" ("ano_referencia", "mes_referencia");



CREATE INDEX "idx_funcionario_beneficios_historico_status" ON "rh"."funcionario_beneficios_historico" USING "btree" ("status");
...
CREATE INDEX "idx_premiacao_assignments_active" ON "rh"."premiacao_assignments" USING "btree" ("is_active");



CREATE INDEX "idx_premiacao_assignments_company_id" ON "rh"."premiacao_assignments" USING "btree" ("company_id");



CREATE INDEX "idx_premiacao_assignments_config_id" ON "rh"."premiacao_assignments" USING "btree" ("premiacao_config_id");



CREATE INDEX "idx_premiacao_assignments_employee_id" ON "rh"."premiacao_assignments" USING "btree" ("employee_id");



CREATE INDEX "idx_premiacao_configs_active" ON "rh"."premiacao_configs" USING "btree" ("is_active");



CREATE INDEX "idx_premiacao_configs_company_id" ON "rh"."premiacao_configs" USING "btree" ("company_id");



CREATE INDEX "idx_premiacao_configs_tipo" ON "rh"."premiacao_configs" USING "btree" ("tipo_premiacao");
...
CREATE OR REPLACE TRIGGER "update_benefit_payment_configs_updated_at" BEFORE UPDATE ON "rh"."benefit_payment_configs" FOR EACH ROW EXECUTE FUNCTION "rh"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_benefit_payments_updated_at" BEFORE UPDATE ON "rh"."benefit_payments" FOR EACH ROW EXECUTE FUNCTION "rh"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_employee_bank_accounts_updated_at" BEFORE UPDATE ON "rh"."employee_bank_accounts" FOR EACH ROW EXECUTE FUNCTION "rh"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_funcionario_beneficios_historico_updated_at" BEFORE UPDATE ON "rh"."funcionario_beneficios_historico" FOR EACH ROW EXECUTE FUNCTION "rh"."update_funcionario_beneficios_historico_updated_at"();
...
CREATE OR REPLACE TRIGGER "update_premiacao_assignments_updated_at" BEFORE UPDATE ON "rh"."premiacao_assignments" FOR EACH ROW EXECUTE FUNCTION "rh"."update_premiacao_assignments_updated_at"();



CREATE OR REPLACE TRIGGER "update_premiacao_configs_updated_at" BEFORE UPDATE ON "rh"."premiacao_configs" FOR EACH ROW EXECUTE FUNCTION "rh"."update_premiacao_configs_updated_at"();
...
ALTER TABLE ONLY "rh"."benefit_payment_configs"
    ADD CONSTRAINT "benefit_payment_configs_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "core"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "rh"."benefit_payments"
    ADD CONSTRAINT "benefit_payments_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "core"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "rh"."benefit_payments"
    ADD CONSTRAINT "benefit_payments_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "rh"."employees"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "rh"."funcionario_beneficios_historico"
    ADD CONSTRAINT "funcionario_beneficios_historico_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "core"."companies"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "rh"."premiacao_assignments"
    ADD CONSTRAINT "premiacao_assignments_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "core"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "rh"."premiacao_assignments"
    ADD CONSTRAINT "premiacao_assignments_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "rh"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "rh"."premiacao_assignments"
    ADD CONSTRAINT "premiacao_assignments_premiacao_config_id_fkey" FOREIGN KEY ("premiacao_config_id") REFERENCES "rh"."premiacao_configs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "rh"."premiacao_configs"
    ADD CONSTRAINT "premiacao_configs_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "core"."companies"("id") ON DELETE CASCADE;
...
CREATE POLICY "Users can delete premiacao_assignments for their company" ON "rh"."premiacao_assignments" FOR DELETE USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can delete premiacao_configs for their company" ON "rh"."premiacao_configs" FOR DELETE USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can insert benefit_payment_configs for their company" ON "rh"."benefit_payment_configs" FOR INSERT WITH CHECK (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can insert benefit_payments for their company" ON "rh"."benefit_payments" FOR INSERT WITH CHECK (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can insert employee_bank_accounts for their company" ON "rh"."employee_bank_accounts" FOR INSERT WITH CHECK (("employee_id" IN ( SELECT "e"."id"
   FROM ("rh"."employees" "e"
...
CREATE POLICY "Users can insert funcionario_beneficios_historico for their com" ON "rh"."funcionario_beneficios_historico" FOR INSERT WITH CHECK (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can insert premiacao_assignments for their company" ON "rh"."premiacao_assignments" FOR INSERT WITH CHECK (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can insert premiacao_configs for their company" ON "rh"."premiacao_configs" FOR INSERT WITH CHECK (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update benefit_payment_configs for their company" ON "rh"."benefit_payment_configs" FOR UPDATE USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can update benefit_payments for their company" ON "rh"."benefit_payments" FOR UPDATE USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update employee_bank_accounts for their company" ON "rh"."employee_bank_accounts" FOR UPDATE USING (("employee_id" IN ( SELECT "e"."id"
   FROM ("rh"."employees" "e"
     JOIN "core"."user_companies" "uc" ON (("e"."company_id" = "uc"."company_id")))
  WHERE ("uc"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update funcionario_beneficios_historico for their com" ON "rh"."funcionario_beneficios_historico" FOR UPDATE USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update premiacao_assignments for their company" ON "rh"."premiacao_assignments" FOR UPDATE USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can update premiacao_configs for their company" ON "rh"."premiacao_configs" FOR UPDATE USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view benefit_payment_configs for their company" ON "rh"."benefit_payment_configs" FOR SELECT USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can view benefit_payments for their company" ON "rh"."benefit_payments" FOR SELECT USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view employee_bank_accounts for their company" ON "rh"."employee_bank_accounts" FOR SELECT USING (("employee_id" IN ( SELECT "e"."id"
   FROM ("rh"."employees" "e"
     JOIN "core"."user_companies" "uc" ON (("e"."company_id" = "uc"."company_id")))
  WHERE ("uc"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view funcionario_beneficios_historico for their compa" ON "rh"."funcionario_beneficios_historico" FOR SELECT USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view premiacao_assignments for their company" ON "rh"."premiacao_assignments" FOR SELECT USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can view premiacao_configs for their company" ON "rh"."premiacao_configs" FOR SELECT USING (("company_id" IN ( SELECT "user_companies"."company_id"
   FROM "core"."user_companies"
  WHERE ("user_companies"."user_id" = "auth"."uid"()))));
...
ALTER TABLE "rh"."premiacao_assignments" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "rh"."premiacao_configs" ENABLE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."benefit_payment_configs" TO PUBLIC;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."benefit_payment_configs" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."benefit_payment_configs" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."benefit_payment_configs" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."benefit_payments" TO PUBLIC;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."benefit_payments" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."benefit_payments" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."benefit_payments" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."premiacao_assignments" TO PUBLIC;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."premiacao_assignments" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."premiacao_assignments" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."premiacao_assignments" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."premiacao_configs" TO PUBLIC;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."premiacao_configs" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."premiacao_configs" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "rh"."premiacao_configs" TO "service_role";
