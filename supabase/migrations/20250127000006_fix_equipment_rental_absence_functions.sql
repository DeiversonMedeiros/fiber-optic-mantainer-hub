-- ============================================================================
-- MIGRAÇÃO: CORRIGIR FUNÇÕES DE DESCONTO POR AUSÊNCIA EM LOCAÇÃO DE EQUIPAMENTOS
-- ============================================================================
--
-- Data: 2025-01-27
-- Descrição: Corrige as funções RPC para usar o campo correto 'effective_work_days'
--           em vez de 'dias_uteis_mes' que não existe
--
-- ============================================================================
