-- ============================================================================
-- MIGRAÇÃO: CRIAR FUNÇÕES DE DESCONTO POR AUSÊNCIA EM LOCAÇÃO DE EQUIPAMENTOS
-- ============================================================================
--
-- Data: 2025-01-27
-- Descrição: Cria as funções RPC para cálculo de descontos por ausência
--           em locação de equipamentos considerando escalas flexíveis
--
-- ============================================================================

-- 1. Função para calcular desconto por ausência para um equipamento específico
...
-- 2. Função para calcular descontos para todos os equipamentos de uma empresa
