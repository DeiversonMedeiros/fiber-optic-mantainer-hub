...
import { ArrowLeft, Building2, TreePine, Filter, Download, Plus } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { UnitsManagement } from '@/components/rh';
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto py-6 px-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">
                  Gerencie a estrutura organizacional da empresa <strong>{userCompany.nome_fantasia || userCompany.razao_social}</strong>
                </p>
              </div>
            </div>
        ...
        {/* Conteúdo principal */}
        <UnitsManagement companyId={userCompany.id} />
      </div>
    </div>
  );
}
