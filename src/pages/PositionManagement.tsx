...
import { ArrowLeft, Briefcase, Building2, Users, Target, Filter, Download, Plus } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { PositionManagement } from '@/components/rh';
    ...
    <div className="w-full">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">
                  Gerencie os cargos e posições da empresa <strong>{userCompany.nome_fantasia || userCompany.razao_social}</strong>
                </p>
              </div>
            </div>
        ...
        <div className="mb-6">
          <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Cargos</span>
          </nav>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Diferentes níveis</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Funcionários Vinculados</CardTitle>
              <Users className="h-4 w-4 text-purple-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">0</div>
              <p className="text-xs text-muted-foreground">Com cargo definido</p>
            </CardContent>
          </Card>
        </div>

        {/* Conteúdo principal */}
        <PositionManagement companyId={userCompany.id} />
    </div>
  );
}
