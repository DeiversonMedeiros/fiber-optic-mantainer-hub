...
import { ArrowLeft, FileText, Users, MapPin, Phone, Filter, Download, Plus } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { CompensationRequestManagement } from '@/components/rh';

export default function CompensationRequestManagementPage() {
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Gerencie as solicitações de compensação de horas da {userCompany.nome_fantasia || userCompany.razao_social}
              </p>
            </div>
          </div>
