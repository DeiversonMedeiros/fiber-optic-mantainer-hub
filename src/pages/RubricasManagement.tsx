...
import { ArrowLeft, DollarSign, Tag, Filter, Download, Plus } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { RubricasManagement } from '@/components/rh';

export default function RubricasManagementPage() {
      ...
      <div className="container mx-auto py-6 px-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">
                  Gerencie as rubricas de folha de pagamento da empresa <strong>{userCompany.nome_fantasia || userCompany.razao_social}</strong>
                </p>
              </div>
            </div>
        ...
        <div className="mb-6">
          <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Rubricas</span>
          </nav>
        </div>

        {/* Conteúdo principal */}
        <RubricasManagement companyId={userCompany.id} />
      </div>
    </div>
  );
}
