...
import { ArrowLeft, Clock, Calendar, Users, Timer, Filter, Download, Plus } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { WorkShiftManagement } from '@/components/rh';
...
export default function WorkShiftManagementPage() {
  ...
  return (
    <div className="w-full">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">
                  Gerencie as escalas e turnos de trabalho da empresa <strong>{userCompany.nome_fantasia || userCompany.razao_social}</strong>
                </p>
              </div>
            </div>
        ...
        {/* Conteúdo principal */}
        <WorkShiftManagement companyId={userCompany.id} />
    </div>
  );
}
