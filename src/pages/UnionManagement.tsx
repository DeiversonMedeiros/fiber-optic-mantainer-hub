...
import { ArrowLeft, Building2, Users, MapPin, Phone, Filter, Download, Plus } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { UnionManagement } from '@/components/rh';
    ...
    <div className="w-full">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold tracking-tight text-foreground">
                  Gestão de Sindicatos
                </h1>
                <p className="text-muted-foreground mt-2">
                  Gerencie os sindicatos relacionados à empresa <strong>{userCompany.nome_fantasia || userCompany.razao_social}</strong>
                </p>
              </div>
            </div>
        ...
        <div className="mb-6">
          <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Sindicatos</span>
          </nav>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Sindicatos cadastrados</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Sindicatos Ativos</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Endereço cadastrado</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Contato cadastrado</p>
            </CardContent>
          </Card>
        </div>

        {/* Conteúdo principal */}
        <UnionManagement companyId={userCompany.id} />
    </div>
  );
}
