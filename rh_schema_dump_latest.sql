...
COMMENT ON FUNCTION "rh"."calculate_all_equipment_rental_absence_discounts"("p_company_id" "uuid", "p_year" integer, "p_month" integer) IS 'Calcula descontos por ausência para todos os equipamentos ativos de uma empresa considerando escalas flexíveis';
...
BEGIN
    ...
    IF v_work_days_result.dias_uteis_mes > 0 THEN
        v_equipment_record.monthly_value := v_equipment_record.monthly_value / 30 * v_work_days_result.dias_uteis_mes;
    END IF;
    ...
    SELECT 
        ...
        v_work_days_result.dias_uteis_mes,
        v_absence_days,
        v_total_discount,
...
COMMENT ON FUNCTION "rh"."calculate_equipment_rental_absence_discount"("p_equipment_rental_id" "uuid", "p_company_id" "uuid", "p_year" integer, "p_month" integer) IS 'Calcula desconto por ausência para um equipamento específico considerando a escala de trabalho do funcionário';
